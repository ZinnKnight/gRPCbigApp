// Code generated by protoc-gen-go-grpcAdapters. DO NOT EDIT.
// versions:
// - protoc-gen-go-grpcAdapters v1.5.1
// - protoc             v6.33.4
// source: order.proto
...
// is compatible with the grpcAdapters package it is being compiled against.
...
type OrderServiceClient interface {
	...
	StreamOrderUpdates(ctx context.Context, in *StreamOrderRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[OrderUpdate], error)
}
...
func (c *orderServiceClient) StreamOrderUpdates(ctx context.Context, in *StreamOrderRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[OrderUpdate], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &OrderService_ServiceDesc.Streams[0], OrderService_StreamOrderUpdates_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[StreamOrderRequest, OrderUpdate]{ClientStream: stream}
...
type OrderServiceServer interface {
	...
	StreamOrderUpdates(*StreamOrderRequest, grpc.ServerStreamingServer[OrderUpdate]) error
...
func (UnimplementedOrderServiceServer) StreamOrderUpdates(*StreamOrderRequest, grpc.ServerStreamingServer[OrderUpdate]) error {
...
func _OrderService_StreamOrderUpdates_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(OrderServiceServer).StreamOrderUpdates(m, &grpc.GenericServerStream[StreamOrderRequest, OrderUpdate]{ServerStream: stream})
}
...
// It's only intended for direct use with grpcAdapters.RegisterService,
