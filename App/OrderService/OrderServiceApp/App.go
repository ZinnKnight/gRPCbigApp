...
import (
	...
	"gRPCbigapp/Proto/protoPB/orderPB"
...
func New(ctx context.Context, cfg *Config.Config, logger LoggerPorts.Logger) (*App, error) {
	...
	orderPB.RegisterOrderServiceServer(app.grpcServer, orderHandler)
	clientPB.RegisterAuthServiceServer(app.grpcServer, clientHandler)
