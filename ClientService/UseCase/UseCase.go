...
var _ Ports2.UserInboundPort = (*UserUseCase)(nil)

type UserUseCase struct {
	repo         Ports2.CSOutboundPorts
...
func NewUserUseCase(repo Ports2.CSOutboundPorts, event Outbox.Emiter, txManager *Txmanager.TxManager,
...
func (us *UserUseCase) UserRegistration(ctx context.Context, rui Ports2.RegisterUserInput) (*Domain.User, error) {
