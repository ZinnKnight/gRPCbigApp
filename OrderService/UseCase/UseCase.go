...
var _ Ports2.OSInboundPort = (*UseCase)(nil)
...
func NewOSUseCase(repo Ports2.OSOutboundPorts,
...
func (uc *UseCase) enforcedOrderQuota(ctx context.Context, cmd Ports2.CreteOrder) error {
...
func (uc *UseCase) CreateOrder(ctx context.Context, cmd Ports2.CreteOrder) (*Domain.OrderDomain, error) {
...
func (uc *UseCase) GetOrderStatusAll(ctx context.Context, userID, pageToken string, pageSize int) ([]*Domain.OrderDomain, string, error) {
	...
	if len(orders) > pageSize {
		next = orders[pageSize-1].OrderID // todo поправить пролистывание
